...
fprintf('Feature Combine: Training Accu = %f\n',TrainingAccuracy);
toc
...
H = combine_Harray(out);
 ...
 testH = load ('testVoxelH.mat');
 H = [H;testH.H];

clear out
TY=(H' * model{layersNum+1}.OutputWeight)';
clear H
save model40_TY_sdf.mat TY;
...
fprintf('Feature Combine: Test Accu = %f\n',TestingAccuracy);

save model40_predLabels_sdf.mat predLabels;
